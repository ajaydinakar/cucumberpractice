...
public class CustomRfc6265CookieProcessor extends CookieProcessorBase {

    private static final Log log = LogFactory.getLog(CustomRfc6265CookieProcessor.class);

    private static final StringManager sm =
            StringManager.getManager(CustomRfc6265CookieProcessor.class.getPackage().getName());
